...
def main():
    ...
    try:
        ...
        lidar_bp.set_attribute('points_per_second',str(480000))
        ...
        lidar_sen.listen(pcl_queue)

        lidar_sen.listen(lambda point_cloud: point_cloud.save_to_disk('tutorial5/new_lidar_output/%.6d.ply' % point_cloud.frame))
