...
class PointCloudNet(nn.Module):
    ...
    def __init__(self, input_channels=3, output_channels=3, num_points=1024):
        ...
        self.UPSAMPLING_module = nn.Sequential(
            nn.ConvTranspose1d(in_channels=1024 + 64 + 256 + 128 + 3, out_channels=2048, kernel_size=1),
            nn.BatchNorm1d(2048),
            nn.ReLU(),
    ...
    def forward(self, pointcloud):
        ...
        c_features = torch.cat([pointcloud.permute(0, 2, 1), l_feature1, l_feature2, l_feature3, g_features.repeat(1, 1, num_points)], dim=1)
