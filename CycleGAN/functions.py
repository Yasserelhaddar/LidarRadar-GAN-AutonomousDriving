...
def voxel2pcl(filename, voxel, segments, shape, n):
    ...
    PCL = np.asarray(PCL_out)

    completeName = 'C:/Users/ElHaddar/OneDrive/Desktop/Cycle GAN/data_4096/Real_data'
    completeName_ply = os.path.join(completeName,"4096_"+filename)

    PCL_out_array = write_pointcloud(completeName_ply,PCL)
...
def pcl2voxel(data, n):
    ...
    voxel = np.zeros((n, n, n)).astype(np.float32)
